...
// Unique photos for each talent - no duplicates
export const talents: Talent[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 127,
    rules: ["Hanya pendamping sosial", "Booking minimal 2 jam", "Lokasi publik saja"],
    availability: "both",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 156,
    rules: ["Hanya pendamping sosial", "Tidak menerima booking malam hari"],
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 72,
    rules: ["Hanya pendamping sosial", "Booking minimal 3 jam untuk traveling"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 64,
    rules: ["Hanya pendamping sosial", "Booking minimal 2 jam", "Lokasi publik"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.5,
    reviewCount: 45,
    rules: ["Hanya pendamping sosial", "Bisa online atau offline", "Booking fleksibel"],
    availability: "both",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 52,
    rules: ["Hanya pendamping sosial", "Booking minimal 2 jam", "Outdoor activities preferred"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 73,
    rules: ["Hanya pendamping sosial", "Lokasi cafe atau bioskop", "Booking minimal 2 jam"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    city: "Bekasi",
    gender: "Wanita",
    photo: "https://images.unsplash.com/photo-1524250502761-1ac6f2e30d43?w=400&h=400&fit=crop&crop=face",
    gallery: [
      "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=600&h=800&fit=crop",
      "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=600&h=800&fit=crop",
    ],
    ...
    rating: 4.8,
    reviewCount: 95,
    rules: ["Hanya pendamping sosial", "Lokasi publik", "Booking minimal 3 jam untuk shopping"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.9,
    reviewCount: 112,
    rules: ["Hanya pendamping sosial", "Outdoor activities", "Booking minimal 4 jam untuk hiking"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.6,
    reviewCount: 58,
    rules: ["Hanya pendamping sosial", "Aktivitas outdoor", "Booking minimal 3 jam"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 67,
    rules: ["Hanya pendamping sosial", "Booking minimal 4 jam", "Beach activities"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.6,
    reviewCount: 49,
    rules: ["Hanya pendamping sosial", "Lokasi publik", "Tidak ada booking malam"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.5,
    reviewCount: 38,
    rules: ["Hanya pendamping sosial", "Outdoor preferred", "Booking fleksibel"],
    availability: "both",
    verified: true,
  },
  {
    ...
    rating: 4.8,
    reviewCount: 76,
    rules: ["Hanya pendamping sosial", "Lokasi restoran atau cafe", "Booking minimal 2 jam"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.9,
    reviewCount: 89,
    rules: ["Hanya pendamping sosial", "Water activities", "Booking minimal 4 jam"],
    availability: "offline",
    verified: true,
  },
  {
