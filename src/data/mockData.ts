...
// Foto unik untuk setiap pendamping - tidak ada duplikat
export const talents: Talent[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 201,
    rules: ["Hanya pendamping sosial", "Aktivitas outdoor diutamakan"],
    availability: "both",
    verified: true,
  },
  {
    ...
    bio: "Pendamping profesional untuk meeting, event bisnis, atau sekadar ngopi sambil brainstorming.",
    pricePerHour: 200000,
    rating: 4.8,
    reviewCount: 93,
    rules: ["Setting profesional", "Hanya pendamping sosial"],
    availability: "both",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 88,
    rules: ["Lokasi publik saja", "Hanya pendamping sosial"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.6,
    reviewCount: 52,
    rules: ["Hanya pendamping sosial", "Pemesanan minimal 2 jam"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 73,
    rules: ["Hanya pendamping sosial", "Lokasi cafe atau bioskop"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 95,
    rules: ["Hanya pendamping sosial", "Lokasi publik"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.9,
    reviewCount: 112,
    rules: ["Hanya pendamping sosial", "Aktivitas outdoor"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 67,
    rules: ["Hanya pendamping sosial", "Pemesanan minimal 4 jam"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 76,
    rules: ["Hanya pendamping sosial", "Lokasi restoran atau cafe"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.9,
    reviewCount: 89,
    rules: ["Hanya pendamping sosial", "Aktivitas air"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.6,
    reviewCount: 54,
    rules: ["Hanya pendamping sosial", "Cafe atau mall"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.8,
    reviewCount: 98,
    rules: ["Hanya pendamping sosial", "Wisata budaya"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 62,
    rules: ["Hanya pendamping sosial", "Wisata kuliner"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.5,
    reviewCount: 43,
    rules: ["Hanya pendamping sosial", "Petualangan"],
    availability: "both",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 56,
    rules: ["Hanya pendamping sosial", "Wisata sungai"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 71,
    rules: ["Pakaian formal", "Hanya pendamping sosial"],
    availability: "both",
    verified: true,
  },
  {
    ...
    rating: 4.7,
    reviewCount: 83,
    rules: ["Hanya pendamping sosial", "Cafe setting"],
    availability: "offline",
    verified: true,
  },
  {
    ...
    rating: 4.6,
    reviewCount: 59,
    rules: ["Hanya pendamping sosial", "Fokus seni & budaya"],
    availability: "both",
    verified: true,
  },
  {
    ...
    rating: 4.9,
    reviewCount: 104,
    rules: ["Hanya pendamping sosial", "Fokus wellness"],
    availability: "both",
    verified: true,
  },
  {
    ...
    rating: 4.5,
    reviewCount: 48,
    rules: ["Hanya pendamping sosial", "Setting kasual"],
    availability: "both",
    verified: true,
  },
  {
    ...
    bio: "Shopping dan foodie expert Medan! Tau semua mall dan tempat makan legendaris.",
    pricePerHour: 110000,
    rating: 4.7,
    reviewCount: 66,
    rules: ["Hanya pendamping sosial", "Siang hari"],
    availability: "offline",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 91,
    rules: ["Hanya pendamping sosial", "Aktivitas pantai"],
    availability: "offline",
    verified: true,
  },
];
